...
namespace glc_cs
{
	class General
	{
		...
		public partial class Var
		{
			...
			/// 最小イメージグリッドをの無効フラグ
			/// </summary>
			protected static bool disableSmallGrid = false;

			/// <summary>
			/// 最大イメージグリッドをの無効フラグ
			/// </summary>
			protected static bool disableLargeGrid = false;
			...
			/// 最小イメージグリッド無効フラグ
			/// </summary>
			public static bool DisableSmallGrid
			{
				get { return disableSmallGrid; }
				set { disableSmallGrid = value; }
			}

			/// <summary>
			/// 最大イメージグリッド無効フラグ
			/// </summary>
			public static bool DisableLargeGrid
			{
				get { return disableLargeGrid; }
				set { disableLargeGrid = value; }
			}
			...
			public static bool GLConfigLoad()
			{
				...
				if (File.Exists(ConfigIni))
				{
					...
					DisableSmallGrid = Convert.ToBoolean(Convert.ToInt32(ReadIni("disable", "disableSmallGrid", "0")));
					DisableLargeGrid = Convert.ToBoolean(Convert.ToInt32(ReadIni("disable", "disableLargeGrid", "0")));
