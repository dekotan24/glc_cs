...
namespace glc_cs
{
	public partial class Config : Form
	{
		...
		private void Form2_Load(object sender, EventArgs e)
		{
			...
			// 最小グリッド無効フラグ
			disableSmallGrid.Checked = DisableSmallGrid;
			// 最大グリッド無効フラグ
			disableLargeGrid.Checked = DisableLargeGrid;
		...
		private void saveButton_Click(object sender, EventArgs e)
		{
			...
			WriteIni("disable", "smallGridIcons", disableSmallGrid.Checked ? "1" : "0");
			WriteIni("disable", "largeGridIcons", disableSmallGrid.Checked ? "1" : "0");
