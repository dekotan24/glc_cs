namespace glc_cs
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelProductName.Text = "Game Launcher C# Edition";
			...
			this.labelVersion.Text = "Version 0.951 Build 18.21.11.04";
			...
			this.labelCopyright.Text = "Ogura Deko, dekosoft All rights reserved.";
			...
			this.labelCompanyName.Text = "https://github.com/dekotan24/glc_cs";
